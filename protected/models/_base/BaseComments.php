...
abstract class BaseComments extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('created_at, updated_at, created_by, status, event_id', 'numerical', 'integerOnly'=>true),
			array('comment_content', 'safe'),
			array('comment_content, created_at, updated_at, created_by, status, event_id', 'default', 'setOnEmpty' => true, 'value' => null),
			array('comment_id, comment_content, created_at, updated_at, created_by, status, event_id', 'safe', 'on'=>'search'),
		);
	}
